    ...
    <div class="container pt-3 pb-5" id="about-us" style="min-height: 70vh">
        ...
        <div class="row">
            ...
            <div class="col-md-10 mx-auto col-lg-10 col-sm-12">
                <section class="py-3">
                    <h4 class="text-start fw-bolder">Shipping</h4>
                ...
                <section class="py-3">
                    <h4 class="text-start fw-bolder">Pre-Orders</h4>
                ...
                <section class="py-3">
                    <h4 class="text-start fw-bolder">International Orders</h4>
                ...
                <section class="py-3">
                    <h4 class="text-start fw-bolder">Returns</h4>
                ...
                <section class="py-3">
                    <h4 class="text-start fw-bolder">Exchanges</h4>
                ...
                <section class="py-3">
                    <h4 class="text-start fw-bolder">Contact</h4>
                    <p>30b Fadunsin Street , Oke-Ira , Ogba , Lagos Nigeria 23401</p>
                    <p>For Shipping and Customer Service enquires, please contact: <span><a href="mailto:orders@aur2611.com"> orders@aur2611.com</a></span></p>
                    <p>For Store buyers, please contact: <span><a href="mailto:orders@aur2611.com"> store@aur2611.com</a></span></p>
                    <p>For Shipping and Customer Service enquires, please contact: <span><a href="mailto:orders@aur2611.com"> work@aur2611.com</a></span></p>
                </section>
