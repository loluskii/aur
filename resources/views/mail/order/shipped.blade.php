                                ...
                                <tr>
                                    <td class="content-cell">
                                        <div class="f-fallback">
                                            ...
                                            <p>We're glad to inform you that your order has successfully been shipped now and is currently on its way to you. Please be reachable for easy delivery once the order gets to your location. View the details of your
                                                purchase below.</p>
                                                        ...
                                                        <table class="purchase_content" width="100%" cellpadding="0"
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td width="20%" class="purchase_footer" valign="middle">
                                                                    <p class="f-fallback purchase_total">£{{ number_format($order->subtotal,2) }}</p>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                ...
                                                                <td width="20%" class="purchase_footer" style="border: none;" valign="middle">
                                                                    <p class="f-fallback purchase_total">£{{ number_format($order->delivery_total,2) }}</p>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td width="80%" class="purchase_footer" style="border: none;" valign="middle">
                                                                ...
                                                                <td width="20%" class="purchase_footer" style="border: none;" valign="middle">
                                                                    <p class="f-fallback purchase_total">£{{ number_format($order->grand_total,2) }}</p>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
                            ...
                            <table class="email-footer" align="center" width="570" cellpadding="0" cellspacing="0"
                                ...
                                <tr>
                                    <td class="content-cell" align="center">
                                        <p class="f-fallback sub align-center">&copy; 2021 AUR2611. All rights
                                            reserved.</p>
