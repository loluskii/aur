...
<div class="container pt-3 pb-5" id="about-us" style="min-height: 75vh">
    ...
    <div class="row">
        ...
        <div class="col-md-4 col-lg-4 col-sm-12 border-end">
            <a href="{{ route('account') }}" class="btn mb-3"> <i class="bi bi-arrow-left"></i> Back</a>
            <section class="py-3 px-3 mb-5">
                <h6 class="text-start fw-bolder">ORDER {{ $order->order_number }}</h6>
                <p class="mb-0">{{ $order->created_at->diffForHumans() }} | <span
                        class="badge {{ $color ?? 'bg-secondary' }}">{{ $status }}</span></p>
            </section>
        ...
        <div class="col-md-8 col-lg-8 col-sm-12">
            <section class="py-3 px-3">
                <h6 class="text-start fw-bolder">Order Details</h6>
                <p class="mb-0">{{ $order->item_count }} Item(s) | Total: ${{ $order->grand_total }}</p>
                <p></p>
            </section>
            <section class="py-3 px-3">
                <h6 class="text-start fw-bolder text-uppercase">Items in your order</h6>
                ...
                <div class="row row-cols-1 row-cols-md-3 g-4">
                    <div class="col-sm-12 col-md-6 col-lg-6">
                        <div class="card border-0 h-100">
                            ...
                            <div class="card-body  border-0">
                                <div class="mb-3">
                                    <h6 class="card-title fw-bold mb-0">Payment Method</h6>
                                    <p class="card-text text-muted">{{ Auth::user()->pm_type }}, ****{{ Auth::user()->pm_last_four }}</p>
                                </div>
                                <div>
                                    <h6 class="card-title">Payment Details</h6>
                                    <p class="mb-0 card-text"><span class="text-muted">Items Total:</span> ${{ number_format($order->subtotal,2) }}</p>
                                    <p class="mb-0 card-text"><span class="text-muted">Shipping Fees:</span> $50</p>
                                    <p class="mb-0 card-text"><span class="text-muted">Grand Total:</span> ${{ number_format($order->grand_total,2) }}</p>
                                </div>
                            </div>
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-6">
                        <div class="card border-0 h-100">
                            ...
                            <div class="card-body  border-0">
                                <div class="mb-3">
                                    <h6 class="card-title fw-bold mb-0">Delivery Method</h6>
