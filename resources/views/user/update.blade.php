    ...
    <div class="container pt-3 pb-5 px-3" id="about-us" style="min-height: 75vh">
        ...
        <div class="row">
            ...
            <div class="col-md-4 col-lg-4 col-sm-12 border-end">
                <a href="{{ route('account') }}" class="btn px-0 mb-3"> <i class="bi bi-arrow-left"></i> Back</a>
                <section class="py-3">
            ...
            <div class="col-md-7 col-lg-8 col-sm-12">
                <section class="py-3 px-0 px-md-3 px-lg-3 px-xl-3">
                    <div class="">
                        <form action="{{ route('account.address.update') }}" style="" method="post" class="pb-5">
                            @csrf
                            <input type="hidden" name="address_id" value="{{ $address->id ?? '' }}">
                            <div class="shipping-information">
                                <h6 class="mb-4 fw-bold">UPDATE ADDRESS</h6>
