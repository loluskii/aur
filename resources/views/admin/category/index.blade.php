...
<div class="row">
    <div class="col-12">
        <div class="card recent-sales">
            <div class="card-body">
                <h5 class="card-title">All Categories <span> </span></h5>
                        ...
                        <tr>
                            ...
                            <td>
                                <a name="" id="" class="btn btn-sm btn-info"
                                    href="{{ route('admin.category.show', $category->id ) }}" role="button">View</a>
                                <button type="button" class="btn btn-primary btn-sm" data-toggle="modal"
                                    data-target="#category{{ $category->id }}"> Edit </button>
                                <!-- Button trigger modal -->
                                                ...
                                                <form action="{{ route('admin.category.update', $category->id) }}"
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <textarea class="form-control"
                                                            name="desc">{{ $category->description }}</textarea>
                                                    </div>
                                                </form>
                                            </div>
                                            <div class="modal-footer">
